...
4. **安装必需插件**
   ...
   - **Calendar** (v1.5.10+) - 日历视图（推荐）
   - **Periodic Notes** (v0.0.17+) - 周期性笔记（推荐）
...
1. **晨间规划** (2 分钟)
   - 右键点击 `10-Daily` 文件夹，选择"新建笔记"（文件名任意）
   - Templater 会自动应用模板并重命名为今日日期
   - 设定 3 个今日重点任务
   - 查看项目仪表盘的今日待办
...
使用 Obsidian 内置的任务功能，结合 Dataview 实现任务管理：
...
### 任务仪表盘
- **项目任务** - 在项目仪表盘 (`00-Dashboard/Current-Projects.md`) 查看任务
- **今日待办** - 在主页仪表盘 (`00-Dashboard/Home.md`) 快速查看
- **每日任务** - 在每日笔记中管理当天任务
